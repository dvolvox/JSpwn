(function (mod) {
  ...
  var eng = require(__dirname + '/engine.js');
  console.log(eng.real_func_names);


  function aw_scan(source, filename) { //Função onde executa o scan e devolve o resultador
    results = [];
    ...
    var ast;
    try {
      ast = acorn.parse(current_source, {
        locations: true
      });
    } catch (e) {
      return [
